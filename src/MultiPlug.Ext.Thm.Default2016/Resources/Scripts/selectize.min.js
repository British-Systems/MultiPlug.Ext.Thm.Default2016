...
var appsoptgroups = null;
var mpapps = [];

function applyselectize(selectizeSelector) {

    if (optgroups == null) {
        PopulateEventsData(selectizeSelector);
        return;
    }

    selectizeSelector.selectize({
        valueField: 'mpeventid',
        labelField: 'mpeventid',
        searchField: ['mpeventid'],
        create: false,
        preload: true,
        optgroupField: 'name',
        sortField: 'name',
        render: {
            ...
            option: function (item, escape) {
                return '<div>' +
                    '<span class="title">' +
                        '<span class="name"><i class="icon"></i>' + escape(item.mpeventid) + '</span>' +
                    '</span>' +
                '</div>';
            }
        },
        load: function (query, callback) {
            var selectizeinst = this;
            $.each(optgroups, function () {
                selectizeinst.addOptionGroup(this.name, this);
            });
            callback(mpeventids);
        }
    });
...
function applyappsselectize(selectizeSelector) {

    if (appsoptgroups == null)
    {
        PopulateAppsData(selectizeSelector);
        return;
    }
    ...
    selectizeSelector.selectize({
        ...
        render: {
            ...
            option: function (item, escape) {
                return '<div>' +
                    '<span class="title">' +
                        '<span class="name"><i class="icon"></i>'+ escape(item.mpapp) + '</span>' +
                    '</span>' +
                '</div>';
            }
        },
